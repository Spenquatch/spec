...
from spec_cli.config.settings import SpecSettings, SettingsManager, get_settings, get_console, SPEC_THEME
...
class TestSpecSettings:
    ...
    def test_spec_settings_initializes_with_correct_paths(self):
    ...
    def test_spec_settings_detects_debug_environment_variables(self):
        """Test that SpecSettings reads debug environment variables correctly."""
        with patch.dict(
            os.environ,
            {"SPEC_DEBUG": "1", "SPEC_DEBUG_LEVEL": "WARNING", "SPEC_DEBUG_TIMING": "yes"},
            clear=True
        ):
    ...
    def test_spec_settings_detects_terminal_environment_variables(self):
    ...
    def test_spec_settings_validates_initialization_state(self):
    ...
    def test_spec_settings_validates_permissions(self):
    ...
    def test_spec_settings_handles_invalid_console_width(self):
    ...
    def test_spec_settings_bool_env_parsing(self):
...
class TestSettingsManager:
    ...
    def test_settings_manager_provides_singleton_behavior(self):
    ...
    def test_settings_manager_handles_root_path_changes(self):
    ...
    def test_settings_manager_resets_console_when_settings_change(self):
    ...
    def test_settings_manager_reset_functionality(self):
...
class TestConsoleIntegration:
    ...
    def test_console_uses_spec_theme_consistently(self):
    ...
    def test_console_respects_color_settings(self):
    ...
    def test_console_handles_width_configuration(self):
...
class TestConvenienceFunctions:
    ...
    def test_get_settings_convenience_function(self):
    ...
    def test_get_console_convenience_function(self):
