...
class TestConfigurationLoader:
    ...
    def test_configuration_loader_loads_from_yaml(self):
    ...
    def test_configuration_loader_loads_from_pyproject_toml(self):
...
"""
    ...
    def test_configuration_loader_handles_missing_files(self):
    ...
    def test_configuration_loader_respects_precedence_order(self):
...
"""
    ...
    def test_configuration_loader_handles_malformed_yaml(self):
    ...
    def test_configuration_loader_handles_malformed_toml(self):
    ...
    def test_configuration_loader_handles_encoding_errors(self):
    ...
    def test_configuration_loader_get_available_sources(self):
    ...
    def test_configuration_loader_validate_source_syntax(self):
    ...
    def test_configuration_loader_handles_empty_yaml(self):
    ...
    def test_configuration_loader_handles_toml_import_error(self):
