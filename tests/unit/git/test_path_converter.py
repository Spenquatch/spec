...
class TestGitPathConverter:
    ...
    def test_path_converter_initialization(self, converter, tmp_path):
        """Test GitPathConverter initializes with correct specs directory."""
        assert converter.specs_dir == tmp_path / ".specs"
    
    def test_path_converter_converts_absolute_paths(self, converter, tmp_path):
    ...
    def test_path_converter_handles_absolute_paths_outside_specs(self, converter, tmp_path):
    ...
    def test_path_converter_removes_specs_prefix(self, converter):
    ...
    def test_path_converter_handles_windows_separators(self, converter):
    ...
    def test_path_converter_handles_relative_paths(self, converter):
    ...
    def test_path_converter_converts_from_git_context(self, converter):
    ...
    def test_path_converter_handles_already_prefixed_from_git(self, converter):
    ...
    def test_path_converter_creates_absolute_specs_paths(self, converter, tmp_path):
    ...
    def test_path_converter_detects_paths_under_specs_dir(self, converter, tmp_path):
    ...
    def test_path_converter_normalizes_path_separators(self, converter):
    ...
    def test_path_converter_provides_conversion_info(self, converter, tmp_path):
    ...
    def test_path_converter_info_for_absolute_path(self, converter, tmp_path):
        ...
        assert info["has_specs_prefix"] is False  # Absolute paths don't have .specs/ prefix
        assert info["git_path"] == "src/main.py"
    
    def test_path_converter_info_for_relative_path(self, converter):
    ...
    def test_path_converter_handles_pathlib_objects(self, converter):
    ...
    def test_path_converter_round_trip_conversion(self, converter):
