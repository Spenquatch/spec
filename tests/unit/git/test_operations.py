...
class TestGitOperations:
    ...
    def test_git_operations_initialization(self, git_ops, tmp_path):
    ...
    def test_git_operations_prepares_environment_correctly(self, git_ops):
    ...
    def test_git_operations_prepares_command_correctly(self, git_ops):
    ...
    def test_git_operations_executes_commands_successfully(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_handles_command_failures(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_handles_missing_git_binary(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_initializes_repository(self, mock_run, git_ops, tmp_path):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_handles_initialization_failure(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_checks_git_availability(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_handles_git_unavailable(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_gets_git_version(self, mock_run, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_handles_version_failure(self, mock_run, git_ops):
    ...
    def test_git_operations_logs_command_execution(self, mock_logger, git_ops):
    ...
    @patch('spec_cli.git.operations.subprocess.run')
    def test_git_operations_working_directory_setting(self, mock_run, git_ops):
