...
from spec_cli.git.repository import SpecGitRepository, GitRepository
...
class TestSpecGitRepository:
    ...
    def test_spec_git_repository_initialization(self, repository, mock_settings):
    ...
    def test_spec_git_repository_is_git_repository_interface(self, repository):
    ...
    def test_spec_git_repository_adds_files_with_force_flag(self, mock_git_ops_class, repository):
    ...
    def test_spec_git_repository_converts_paths_for_add(self, repository):
    ...
    def test_spec_git_repository_creates_commits(self, repository):
        ...
        with patch.object(repository.operations, 'run_git_command') as mock_run:
            ...
            mock_run.assert_called_once_with(["commit", "-m", message])
    
    def test_spec_git_repository_shows_status(self, repository):
        """Test status display."""
        with patch.object(repository.operations, 'run_git_command') as mock_run:
            repository.status()
    ...
    def test_spec_git_repository_shows_log_without_path_filter(self, repository):
    ...
    def test_spec_git_repository_shows_log_with_path_filter(self, repository):
    ...
    def test_spec_git_repository_shows_diff_without_path_filter(self, repository):
    ...
    def test_spec_git_repository_shows_diff_with_path_filter(self, repository):
    ...
    def test_spec_git_repository_detects_uninitialized_repository(self, repository, tmp_path):
    ...
    def test_spec_git_repository_detects_initialized_repository(self, repository, tmp_path):
    ...
    def test_spec_git_repository_detects_spec_dir_as_file(self, repository, tmp_path):
    ...
    def test_spec_git_repository_initializes_repository(self, repository, tmp_path):
    ...
    def test_spec_git_repository_skips_initialization_if_already_initialized(self, repository, tmp_path):
    ...
    def test_spec_git_repository_gets_repository_info(self, repository, tmp_path):
    ...
    def test_spec_git_repository_info_includes_file_existence_when_initialized(self, repository, tmp_path):
    ...
    def test_spec_git_repository_info_handles_errors(self, repository):
    ...
    def test_spec_git_repository_uses_provided_settings(self, mock_settings):
        """Test that repository uses provided settings instead of defaults."""
        repo = SpecGitRepository(mock_settings)
        
        assert repo.settings == mock_settings
    
    def test_spec_git_repository_uses_default_settings_when_none_provided(self):
    ...
    def test_spec_git_repository_handles_long_commit_messages(self, repository):
        ...
        with patch.object(repository.operations, 'run_git_command') as mock_run:
            ...
            # Should still work (logging truncates the message)
            mock_run.assert_called_once_with(["commit", "-m", long_message])
    
    def test_spec_git_repository_path_converter_integration(self, repository):
