...
class TestSpecTheme:
    ...
    def test_spec_theme_initialization(self):
    ...
    def test_color_scheme_variations(self):
    ...
    def test_theme_style_retrieval(self):
    ...
    def test_emoji_replacements_mapping(self):
    ...
    def test_theme_from_settings(self):
        ...
        with patch('spec_cli.ui.theme.get_settings', return_value=mock_settings_no_color):
        ...
        with patch('spec_cli.ui.theme.get_settings', return_value=mock_settings_invalid):
