...
class TestErrorPanel:
    ...
    def test_error_panel_initialization(self):
    ...
    def test_error_panel_with_custom_title(self):
    ...
    def test_error_panel_without_traceback(self):
    ...
    def test_get_error_title_spec_error(self):
    ...
    def test_get_error_title_value_error(self):
    ...
    def test_get_error_title_type_error(self):
    ...
    def test_get_error_title_generic_error(self):
    ...
    def test_create_panel_with_spec_error_details(self):
    ...
    def test_get_error_context_file_not_found(self):
    ...
    def test_get_error_context_permission_error(self):
    ...
    def test_get_error_suggestions_empty(self):
    ...
    def test_format_traceback_success(self):
    ...
    def test_format_traceback_truncation(self):
    ...
    def test_format_traceback_none_on_error(self):
    ...
    def test_print_error_panel(self, mock_get_console):
...
class TestDiagnosticDisplay:
    ...
    def test_diagnostic_display_initialization(self):
        """Test DiagnosticDisplay initialization."""
        display = DiagnosticDisplay()
        
        assert display.console is not None

    def test_diagnostic_display_with_custom_console(self):
    ...
    def test_show_configuration_simple(self):
    ...
    def test_show_configuration_nested(self):
    ...
    def test_show_file_details_existing_file(self):
    ...
    def test_show_file_details_nonexistent_file(self):
...
class TestStackTraceFormatter:
    ...
    def test_stack_trace_formatter_initialization(self):
        """Test StackTraceFormatter initialization."""
        formatter = StackTraceFormatter()
        
        assert formatter.console is not None

    def test_stack_trace_formatter_with_custom_console(self):
    ...
    def test_format_exception_max_frames(self):
    ...
    def test_print_exception_with_options(self):
...
class TestUtilityFunctions:
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_error_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_error_with_options(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_warning_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_warning_with_details(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_success_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_success_with_details(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_info_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_show_info_with_details(self, mock_get_console):
    ...
    def test_show_message_success(self, mock_info, mock_error, mock_warning, mock_success):
    ...
    @patch('spec_cli.ui.error_display.show_error')
    @patch('spec_cli.ui.error_display.show_info')
    def test_show_message_warning(self, mock_info, mock_error, mock_warning, mock_success):
    ...
    @patch('spec_cli.ui.error_display.show_error')
    @patch('spec_cli.ui.error_display.show_info')
    def test_show_message_error(self, mock_info, mock_error, mock_warning, mock_success):
    ...
    @patch('spec_cli.ui.error_display.show_error')
    @patch('spec_cli.ui.error_display.show_info')
    def test_show_message_default_info(self, mock_info, mock_error, mock_warning, mock_success):
    ...
    @patch('spec_cli.ui.error_display.show_error')
    @patch('spec_cli.ui.error_display.show_info')
    def test_show_message_with_context(self, mock_info, mock_error, mock_warning, mock_success):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_format_data_dict_auto(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_format_data_list_auto(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_format_data_string_auto(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_format_data_with_title(self, mock_get_console):
    ...
    @patch('spec_cli.ui.error_display.get_console')
    def test_format_data_specific_format(self, mock_get_console):
    ...
    def test_format_code_snippet_with_language(self):
    ...
    def test_format_code_snippet_with_theme(self):
    ...
    def test_format_code_snippet_with_highlights(self):
    ...
    def test_format_code_snippet_all_options(self):
...
class TestErrorIntegration:
    ...
    def test_spec_error_with_details_full_flow(self):
