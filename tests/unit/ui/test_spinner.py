...
class TestSpecSpinner:
    ...
    def test_spec_spinner_initialization_defaults(self):
    ...
    def test_spec_spinner_initialization_custom(self):
    ...
    def test_spec_spinner_start(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_start_already_running(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_stop(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_stop_not_running(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_update_text_running(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_update_text_not_running(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_context_manager(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spec_spinner_context_manager_exception(self, mock_get_console, mock_text, mock_live_class):
...
class TestTimedSpinner:
    ...
    def test_timed_spinner_initialization(self):
    ...
    def test_timed_spinner_start(self, mock_timer_class, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    @patch('threading.Timer')
    def test_timed_spinner_stop(self, mock_timer_class, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_timed_spinner_timeout_callback(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    @patch('threading.Timer')
    def test_timed_spinner_context_manager(self, mock_timer_class, mock_get_console, mock_text, mock_live_class):
...
class TestSpinnerManager:
    ...
    def test_spinner_manager_custom_console(self):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_create_spinner(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_create_spinner_duplicate(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_start_spinner(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_start_spinner_not_found(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_stop_spinner(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_stop_spinner_not_found(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_update_spinner_text(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_update_spinner_text_not_found(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_remove_spinner(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_remove_spinner_not_found(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_stop_all_spinners(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spinner_context_manager(self, mock_get_console, mock_text, mock_live_class):
...
class TestConvenienceFunctions:
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_create_spinner_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_create_spinner_function_defaults(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_timed_spinner_function(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_timed_spinner_function_defaults(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spinner_context_function(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spinner_context_function_defaults(self, mock_get_console, mock_text, mock_live_class):
    ...
    @patch('spec_cli.ui.spinner.Text')
    @patch('spec_cli.ui.spinner.get_console')
    def test_spinner_context_function_exception(self, mock_get_console, mock_text, mock_live_class):
...
class TestSpinnerIntegration:
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_multiple_spinners_basic(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    @patch('threading.Timer')
    def test_timed_spinner_timeout_simulation(self, mock_timer_class, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_spinner_state_management(self, mock_get_console):
    ...
    @patch('spec_cli.ui.spinner.get_console')
    def test_error_handling(self, mock_get_console):
