...
class TestSpecConsole:
    ...
    def test_spec_console_initialization(self):
    ...
    def test_console_emoji_replacement(self):
    ...
    def test_console_status_printing(self):
    ...
    def test_console_theme_updates(self):
    ...
    def test_console_export_functionality(self):
    ...
    def test_global_console_management(self):
...
class TestConsoleIntegration:
    ...
    def test_console_with_settings_integration(self):
        ...
        with patch('spec_cli.ui.console.get_settings', return_value=mock_settings_default):
            reset_console()
            console = get_console()
            assert console.no_color is False
    ...
    def test_console_properties_and_methods(self):
...
class TestEmojiReplacement:
    ...
    def test_emoji_replacement_edge_cases(self):
    ...
    def test_no_color_emoji_stripping(self):
