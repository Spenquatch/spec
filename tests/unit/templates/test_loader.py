...
class TestTemplateLoader:
    ...
    def test_template_loader_loads_from_yaml_file(self, temp_dir, mock_settings):
    ...
    def test_template_loader_uses_defaults_when_file_missing(self, mock_settings):
    ...
    def test_template_loader_handles_empty_yaml_file(self, temp_dir, mock_settings):
    ...
    def test_template_loader_validates_loaded_templates(self, temp_dir, mock_settings):
        ...
        assert "validation failed" in error_msg or "error reading template file" in error_msg
    
    def test_template_loader_handles_invalid_yaml(self, temp_dir, mock_settings):
    ...
    def test_template_loader_saves_template_configuration(self, temp_dir, mock_settings):
    ...
    def test_template_loader_backs_up_existing_files(self, temp_dir, mock_settings):
    ...
    def test_template_loader_gets_template_info(self, temp_dir, mock_settings):
...
class TestLoadTemplateFunction:
    ...
    def test_load_template_convenience_function(self):
    ...
    def test_load_template_with_custom_settings(self):
...
class TestTemplateLoaderEdgeCases:
    ...
    def test_template_loader_handles_non_dict_yaml(self, temp_dir, mock_settings):
    ...
    def test_template_loader_handles_file_permission_errors(self, temp_dir, mock_settings):
        ...
        with patch.object(loader, '_load_from_file', side_effect=PermissionError("Access denied")):
            with pytest.raises(SpecTemplateError) as exc_info:
                loader.load_template()
            
            assert "Failed to load template configuration" in str(exc_info.value)
    
    def test_template_loader_save_validates_before_saving(self, mock_settings):
    ...
    def test_template_loader_backup_handles_errors_gracefully(self, temp_dir, mock_settings):
    ...
    def test_template_loader_get_info_handles_corrupt_file(self, temp_dir, mock_settings):
