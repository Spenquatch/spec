...
class TestContentMerger:
    ...
    def test_content_section_detection(self, content_merger):
...
"""
    ...
    def test_content_section_detection_yaml_frontmatter(self, content_merger):
...
"""
    ...
    def test_markdown_content_merging_strategies(self, content_merger):
        """Test different content merging strategies."""
        base_content = "# Original Title\n\nOriginal content here."
        new_content = "# New Title\n\nNew content here."
        
        # Test replace strategy
        result = content_merger.merge_markdown_content(base_content, new_content, "replace")
        assert result == new_content
        
        # Test append strategy
        result = content_merger.merge_markdown_content(base_content, new_content, "append")
        expected = base_content + "\n\n" + new_content
        assert result == expected
        
        # Test prepend strategy
        result = content_merger.merge_markdown_content(base_content, new_content, "prepend")
    ...
    def test_intelligent_merge_strategy(self, content_merger):
...
"""
        ...
        result = content_merger.merge_markdown_content(base_content, new_content, "intelligent")
    ...
    def test_conflict_detection_in_content(self, content_merger):
...
"""
        ...
        heading_conflicts = [c for c in conflicts if c["type"] == "heading_level_conflict"]
    ...
    def test_conflict_detection_content_divergence(self, content_merger):
        ...
        divergence_conflicts = [c for c in conflicts if c["type"] == "content_divergence"]
    ...
    def test_merge_preview_generation(self, content_merger):
...
"""
        ...
        preview = content_merger.create_merge_preview(base_content, new_content, "intelligent")
        ...
        error_preview = content_merger.create_merge_preview(base_content, new_content, "invalid_strategy")
    ...
    def test_metadata_diff_extraction(self, content_merger):
...
"""
    ...
    def test_complex_content_section_detection(self, content_merger):
...
"""
    ...
    def test_merge_with_empty_content(self, content_merger):
    ...
    def test_merge_preview_error_handling(self, content_merger):
        ...
        with unittest.mock.patch.object(content_merger, 'merge_markdown_content', side_effect=Exception("Merge error")):
            preview = content_merger.create_merge_preview(base_content, new_content, "intelligent")
    ...
    def test_content_similarity_calculation(self, content_merger):
