...
class TestFileTypeDetector:
    ...
    def test_file_type_detector_identifies_programming_languages(self, detector):
    ...
    def test_file_type_detector_identifies_web_technologies(self, detector):
    ...
    def test_file_type_detector_identifies_data_formats(self, detector):
    ...
    def test_file_type_detector_identifies_special_filenames(self, detector):
    ...
    def test_file_type_detector_handles_case_insensitive_extensions(self, detector):
    ...
    def test_file_type_detector_handles_files_without_extensions(self, detector):
    ...
    def test_is_binary_file_identifies_executables_and_libraries(self, detector):
    ...
    def test_is_binary_file_identifies_images_and_media(self, detector):
    ...
    def test_is_binary_file_returns_false_for_text_files(self, detector):
    ...
    def test_is_processable_file_rejects_binary_files(self, detector):
    ...
    def test_is_processable_file_rejects_unknown_types(self, detector):
    ...
    def test_is_processable_file_rejects_oversized_files(self, mock_stat, mock_exists, detector):
    ...
    def test_get_supported_filenames(self, detector):
    ...
    def test_get_file_category(self, detector):
