...
class TestDirectoryTraversal:
    ...
    @pytest.fixture
    def complex_directory(self, temp_dir: Path) -> Path:
    ...
    @pytest.fixture
    def traversal(self, complex_directory: Path) -> DirectoryTraversal:
        """Create a DirectoryTraversal instance for testing."""
        return DirectoryTraversal(complex_directory)

    def test_directory_traversal_finds_processable_files(
        self, traversal: DirectoryTraversal, complex_directory: Path
    ) -> None:
    ...
    def test_directory_traversal_respects_ignore_patterns(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_respects_max_files_limit(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_analyzes_structure(
        self, traversal: DirectoryTraversal, complex_directory: Path
    ) -> None:
        ...
        assert (
            "markdown" in analysis["file_types"]
            or "documentation" in analysis["file_types"]
        )
    ...
    def test_directory_traversal_finds_files_by_pattern(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_creates_directory_summary(
        self, traversal: DirectoryTraversal, complex_directory: Path
    ) -> None:
    ...
    def test_directory_traversal_handles_non_existent_directory(
        self, temp_dir: Path
    ) -> None:
    ...
    def test_directory_traversal_handles_empty_directory(self, temp_dir: Path) -> None:
    ...
    def test_directory_traversal_handles_file_access_errors(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_format_size_utility(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_top_items_utility(
        self, traversal: DirectoryTraversal
    ) -> None:
    ...
    def test_directory_traversal_relative_path_handling(self, temp_dir: Path) -> None:
    ...
    def test_directory_traversal_large_directory_depth(self, temp_dir: Path) -> None:
    ...
    def test_directory_traversal_summary_with_errors(self, temp_dir: Path) -> None:
    ...
    def test_directory_traversal_logs_operations(
        self, mock_logger: Mock, traversal: DirectoryTraversal
    ) -> None:
