...
class TestIgnorePatternMatcher:
    ...
    def test_ignore_patterns_loads_default_patterns(self, mock_settings):
    ...
    def test_ignore_patterns_loads_from_specignore_file(self, mock_settings):
...
""".strip()
    ...
    def test_ignore_patterns_handles_missing_specignore_file(self, mock_settings):
    ...
    def test_ignore_patterns_handles_malformed_specignore_file(self, mock_settings):
    ...
    def test_gitignore_to_regex_handles_wildcards(self, mock_settings):
    ...
    def test_gitignore_to_regex_handles_directory_patterns(self, mock_settings):
    ...
    def test_gitignore_to_regex_handles_negation_patterns(self, mock_settings):
...
""".strip()
    ...
    def test_should_ignore_matches_file_patterns(self, mock_settings):
        ...
        for file_path, should_ignore in test_cases:
            ...
            assert result == should_ignore, f"Path '{file_path}' should_ignore={should_ignore}"

    def test_should_ignore_matches_directory_patterns(self, mock_settings):
...
""".strip()
    ...
    def test_should_ignore_respects_negation_patterns(self, mock_settings):
...
""".strip()
    ...
    def test_filter_paths_removes_ignored_files(self, mock_settings):
...
""".strip()
    ...
    def test_runtime_pattern_addition_works(self, mock_settings):
    ...
    def test_pattern_summary_provides_debug_info(self, mock_settings):
...
""".strip()
    ...
    def test_path_normalization_handles_different_separators(self, mock_settings):
    ...
    def test_reload_patterns_updates_matcher(self, mock_settings):
    ...
    def test_debug_logging_tracks_operations(self, mock_logger, mock_settings):
