...
class TestPathResolver:
    ...
    def test_path_resolver_initializes_with_default_settings(self):
        """Test that PathResolver initializes with default settings."""
        with patch("spec_cli.file_system.path_resolver.get_settings") as mock_get_settings:
    ...
    def test_path_resolver_initializes_with_custom_settings(self):
    ...
    def test_resolve_input_path_handles_current_directory(self):
    ...
    def test_resolve_input_path_handles_relative_paths(self):
    ...
    def test_resolve_input_path_handles_absolute_paths_within_project(self):
    ...
    def test_resolve_input_path_rejects_paths_outside_project(self):
    ...
    def test_resolve_input_path_handles_os_errors(self):
    ...
    def test_convert_to_spec_directory_path_creates_correct_structure(self):
    ...
    def test_convert_to_spec_directory_path_handles_nested_files(self):
    ...
    def test_convert_to_spec_directory_path_removes_file_extension(self):
    ...
    def test_convert_from_specs_path_handles_absolute_specs_paths(self):
    ...
    def test_convert_from_specs_path_handles_relative_specs_paths(self):
    ...
    def test_convert_from_specs_path_removes_specs_prefix(self):
    ...
    def test_convert_from_specs_path_handles_non_specs_paths(self):
    ...
    def test_is_within_project_accepts_valid_paths(self):
    ...
    def test_is_within_project_rejects_external_paths(self):
    ...
    def test_get_absolute_path_converts_correctly(self):
    ...
    def test_validate_path_exists_passes_for_existing_paths(self):
    ...
    def test_validate_path_exists_raises_for_missing_paths(self):
    ...
    def test_ensure_within_project_with_valid_path(self):
    ...
    def test_ensure_within_project_with_invalid_path(self):
