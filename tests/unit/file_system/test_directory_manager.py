...
class TestDirectoryManager:
    ...
    def test_directory_manager_ensures_specs_directory(self, manager, mock_settings):
    ...
    def test_directory_manager_creates_spec_directories(self, manager, mock_settings):
    ...
    def test_directory_manager_checks_existing_specs(self, manager, mock_settings, temp_dir):
    ...
    def test_directory_manager_creates_backups(self, manager, temp_dir):
    ...
    def test_directory_manager_removes_directories_safely(self, manager, temp_dir):
    ...
    def test_directory_manager_sets_up_ignore_files(self, manager, mock_settings):
    ...
    def test_directory_manager_updates_gitignore(self, manager, mock_settings):
    ...
    def test_directory_manager_handles_permission_errors(self, manager, mock_settings):
    ...
    def test_directory_manager_handles_directory_stats(self, manager, temp_dir):
    ...
    def test_directory_manager_logs_operations(self, mock_logger, manager, mock_settings):
    ...
    def test_directory_manager_handles_os_errors(self, manager, mock_settings):
    ...
    def test_directory_manager_backup_empty_directory(self, manager, temp_dir):
    ...
    def test_directory_manager_removes_non_existent_directory(self, manager, temp_dir):
    ...
    def test_directory_manager_gitignore_already_updated(self, manager, mock_settings):
