...
class TestFileMetadataExtractor:
    ...
    @pytest.fixture
    def extractor(self) -> FileMetadataExtractor:
    ...
    @pytest.fixture
    def temp_binary_file(self) -> Generator[Path, None, None]:
    ...
    def test_file_metadata_extracts_basic_information(
        self, extractor: FileMetadataExtractor, temp_file: Path
    ) -> None:
    ...
    def test_file_metadata_handles_binary_files(
        self, extractor: FileMetadataExtractor, temp_binary_file: Path
    ) -> None:
    ...
    def test_file_metadata_counts_lines_for_text_files(
        self, extractor: FileMetadataExtractor, temp_file: Path
    ) -> None:
    ...
    def test_file_metadata_handles_permission_errors(
    ...
    def test_file_metadata_formats_sizes_correctly(
        self, extractor: FileMetadataExtractor
    ) -> None:
    ...
    def test_directory_composition_analyzes_mixed_files(
        self, extractor: FileMetadataExtractor, temp_dir: Path
    ) -> None:
    ...
    def test_directory_composition_handles_empty_directory(
        self, extractor: FileMetadataExtractor
    ) -> None:
    ...
    def test_file_comparison_identifies_differences(
        self, extractor: FileMetadataExtractor, temp_dir: Path
    ) -> None:
    ...
    def test_metadata_handles_relative_paths(
        self, extractor: FileMetadataExtractor
    ) -> None:
    ...
    def test_metadata_logs_operations(
        self, mock_logger: Any, extractor: FileMetadataExtractor, temp_file: Path
    ) -> None:
    ...
    def test_line_counting_handles_encoding_issues(
        self, extractor: FileMetadataExtractor
    ) -> None:
    ...
    def test_metadata_handles_stat_errors(
        self, mock_stat: Any, extractor: FileMetadataExtractor, temp_file: Path
    ) -> None:
    ...
    def test_directory_composition_handles_non_directory(
        self, extractor: FileMetadataExtractor, temp_file: Path
    ) -> None:
