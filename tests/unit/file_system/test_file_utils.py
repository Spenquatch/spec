...
class TestFileUtils:
    ...
    def test_ensure_file_readable_validates_accessibility(self, temp_file):
    ...
    def test_file_extension_stats_counts_correctly(self, temp_dir_with_files):
    ...
    def test_largest_files_finder_sorts_by_size(self, temp_dir_with_files):
    ...
    def test_recently_modified_finder_sorts_by_time(self, temp_dir_with_files):
        ...
        recent_files = file_utils.find_recently_modified_files(temp_dir_with_files, limit=3)
        ...
        if len(recent_files) > 1:
            for i in range(len(recent_files) - 1):
                assert recent_files[i]["modified_time"] >= recent_files[i + 1]["modified_time"]

    def test_safe_file_operation_checks_permissions(self, temp_file):
    ...
    def test_file_filtering_by_size_works_correctly(self, temp_dir_with_files):
    ...
    def test_unique_extensions_extraction(self, temp_dir_with_files):
    ...
    def test_find_functions_handle_invalid_directory(self):
    ...
    def test_find_functions_with_file_as_directory(self, temp_file):
    ...
    def test_functions_log_operations(self, mock_logger, temp_dir_with_files):
    ...
    def test_permission_checking_with_access_error(self, temp_file):
    ...
    def test_file_stats_excludes_directories(self, temp_dir_with_files):
    ...
    def test_size_filtering_handles_stat_errors(self, temp_dir_with_files):
        ...
        non_existent_files = [Path("/non/existent/file1.txt"), Path("/non/existent/file2.txt")]
        filtered_non_existent = file_utils.filter_files_by_size(non_existent_files, min_size=0)
