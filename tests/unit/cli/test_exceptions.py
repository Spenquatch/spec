...
class TestCLIExceptions:
    ...
    def test_cli_validation_error_with_parameter(self) -> None:
    ...
    def test_cli_validation_error_without_suggestions(self) -> None:
    ...
    def test_cli_operation_error(self) -> None:
...
class TestExceptionConversion:
    ...
    def test_convert_click_exception_unchanged(self) -> None:
    ...
    def test_convert_cli_error(self) -> None:
    ...
    def test_convert_spec_error(self) -> None:
    ...
    def test_convert_generic_error(self) -> None:
...
class TestValidationErrorHandling:
    ...
    def test_handle_validation_error_without_suggestions(self) -> None:
    ...
    def test_handle_validation_error_with_suggestions(self) -> None:
    ...
    def test_handle_validation_error_with_empty_suggestions(self) -> None:
