...
class TestContentViewer:
    ...
    def test_get_syntax_language_when_python_extension_then_returns_python(self):
    ...
    def test_get_syntax_language_when_unknown_extension_then_returns_text(self):
    ...
    def test_looks_like_markdown_when_contains_header_then_returns_true(self):
    ...
    def test_looks_like_markdown_when_plain_text_then_returns_false(self):
