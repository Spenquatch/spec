...
class TestHistoryPackageImports:
    ...
    def test_import_history_package(self):
    ...
    def test_import_diff_viewer(self):
        """Test importing diff viewer from history package."""
        try:
            from spec_cli.cli.commands.history import (
                DiffViewer, create_diff_view, display_file_diff, display_unified_diff
            )
    ...
    def test_import_content_viewer(self):
        """Test importing content viewer from history package."""
        try:
            from spec_cli.cli.commands.history import (
                ContentViewer, display_spec_content, display_file_content, create_content_display
            )
