...
class TestGenerationResult:
    ...
    def test_summary_when_empty_result_then_returns_zero_counts(self):
    ...
    def test_summary_when_files_processed_then_returns_correct_counts(self):
...
class TestAddWorkflow:
    ...
    def test_is_spec_file_when_file_in_specs_directory_then_returns_true(self):
    ...
    def test_is_spec_file_when_file_outside_specs_directory_then_returns_false(self):
...
class TestFactoryFunctions:
    ...
    def test_create_add_workflow_when_called_then_returns_add_workflow(self):
        """Test that create_add_workflow returns AddWorkflow instance."""
        result = create_add_workflow()

        assert isinstance(result, AddWorkflow)

    def test_create_add_workflow_when_force_provided_then_passes_to_constructor(self):
