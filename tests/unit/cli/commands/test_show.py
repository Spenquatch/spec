...
class TestShowCommand:
    ...
    def test_show_command_displays_current_file_content(
        self, mock_validate: Mock, mock_show_current: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_displays_file_from_commit(
        self, mock_validate: Mock, mock_get_repo: Mock, mock_show_commit: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.show._show_current_file")
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_handles_spec_file_formatting(
        self, mock_validate: Mock, mock_show_current: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.show._show_current_file")
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_raw_output_mode(
        self, mock_validate: Mock, mock_show_current: Mock, mock_console: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_no_valid_files(self, mock_validate: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_handles_file_error(self, mock_validate: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.show._show_current_file")
    @patch("spec_cli.cli.commands.show.validate_file_paths")
    def test_show_command_multiple_files(
        self, mock_validate: Mock, mock_show_current: Mock
    ) -> None:
...
class TestShowUtilityFunctions:
    ...
    def test_show_current_file_success(
        self, mock_file: Mock, mock_display: Mock
    ) -> None:
    ...
    def test_show_current_file_not_found(self, mock_show_message: Mock) -> None:
    ...
    def test_show_current_file_raw_mode(
        self, mock_file: Mock, mock_console: Mock
    ) -> None:
    ...
    def test_show_current_file_encoding_fallback(
        self, mock_file: Mock, mock_show_message: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.show.get_console")
    @patch("spec_cli.cli.commands.show.display_file_content")
    def test_show_file_from_commit_success(
        self, mock_display: Mock, mock_console: Mock
    ) -> None:
        ...
        _show_file_from_commit(
            mock_repo, Path("test.py"), "abc123", False, False, False
        )

        mock_repo.get_file_content_at_commit.assert_called_once_with(
            "test.py", "abc123"
        )
        mock_display.assert_called_once()

    @patch("spec_cli.cli.commands.show.show_message")
    def test_show_file_from_commit_not_found(self, mock_show_message: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.show.get_console")
    def test_show_file_from_commit_raw_mode(self, mock_console: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.show.show_message")
    def test_show_file_from_commit_error(self, mock_show_message: Mock) -> None:
    ...
    def test_is_spec_file_true(self) -> None:
        """Test detecting spec files correctly."""
        spec_file = Path(".specs/test.py/index.md")

        with patch("pathlib.Path.relative_to", return_value=Path("test.py/index.md")):
            result = _is_spec_file(spec_file)

        assert result is True

    def test_is_spec_file_false_not_in_specs(self) -> None:
    ...
    def test_is_spec_file_false_not_markdown(self) -> None:
        """Test detecting non-markdown files in specs directory."""
        non_md_file = Path(".specs/test.py/config.json")

        with patch(
            "pathlib.Path.relative_to", return_value=Path("test.py/config.json")
        ):
            result = _is_spec_file(non_md_file)

        assert result is False

    def test_parse_spec_content_with_frontmatter(self) -> None:
...
This is the spec content."""
    ...
    def test_parse_spec_content_without_frontmatter(self) -> None:
    ...
    def test_parse_spec_content_invalid(self) -> None:
