...
class TestHelpCommand:
    ...
    def test_help_command_main_help(self):
    ...
    def test_help_command_specific_command_init(self):
    ...
    def test_help_command_specific_command_status(self):
    ...
    def test_help_command_specific_command_help(self):
    ...
    def test_help_command_help_display(self):
...
class TestHelpHelperFunctions:
    ...
    def test_display_main_help(self):
    ...
    def test_display_command_help_valid_command(self):
    ...
    def test_display_command_help_invalid_command(self):
    ...
    def test_get_command_help_data(self):
