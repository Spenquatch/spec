...
from spec_cli.cli.commands.diff import (
    _display_diff_stats,
    _display_plain_diff,
    diff_command,
)
...
class TestDiffCommand:
    ...
    def test_diff_command_working_directory_changes(
        self, mock_format_diff: Mock, mock_get_repo: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    @patch("spec_cli.cli.commands.diff.format_diff_output")
    def test_diff_command_staged_changes(
        self, mock_format_diff: Mock, mock_get_repo: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    @patch("spec_cli.cli.commands.diff.format_diff_output")
    def test_diff_command_compare_with_commit(
        self, mock_format_diff: Mock, mock_get_repo: Mock
    ) -> None:
        ...
        assert result.exit_code == 0
        mock_repo.get_commit_diff.assert_called_once_with(
            "abc123", files=None, unified=3
        )
        mock_format_diff.assert_called_once()

    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    @patch("spec_cli.cli.commands.diff._display_diff_stats")
    def test_diff_command_stat_summary_only(
        self, mock_display_stats: Mock, mock_get_repo: Mock
    ) -> None:
    ...
    def test_diff_command_no_differences(
        self, mock_show_message: Mock, mock_get_repo: Mock
    ) -> None:
    ...
    def test_diff_command_no_color(
        self, mock_display_plain: Mock, mock_get_repo: Mock
    ) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    def test_diff_command_with_files(self, mock_get_repo: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    def test_diff_command_unified_context(self, mock_get_repo: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_spec_repository")
    def test_diff_command_repository_error(self, mock_get_repo: Mock) -> None:
...
class TestDiffUtilityFunctions:
    ...
    def test_display_diff_stats_no_files(self, mock_get_console: Mock) -> None:
    ...
    def test_display_diff_stats_with_files(
        ...
        diff_data = {
            "files": [
                {"filename": "test1.py", "insertions": 10, "deletions": 5},
                {"filename": "test2.py", "insertions": 3, "deletions": 2},
            ]
        }
    ...
    @patch("spec_cli.cli.commands.diff.get_console")
    def test_display_diff_stats_with_many_files(self, mock_get_console: Mock) -> None:
        ...
        for i in range(15):
            files.append(
                {"filename": f"test{i}.py", "insertions": i, "deletions": i // 2}
            )
    ...
    @patch("spec_cli.cli.commands.diff.get_console")
    def test_display_plain_diff(self, mock_get_console: Mock) -> None:
    ...
    @patch("spec_cli.cli.commands.diff.get_console")
    def test_display_plain_diff_empty(self, mock_get_console: Mock) -> None:
    ...
    def test_diff_command_help(self) -> None:
