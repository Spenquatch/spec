...
class TestStatusCommand:
    ...
    def test_status_command_success(self, mock_display, mock_get_status, mock_get_repo):
    ...
    def test_status_command_health_check(self, mock_display, mock_get_health, mock_get_repo):
    ...
    def test_status_command_with_git(self, mock_display_git, mock_get_git_status, mock_display, mock_get_status, mock_get_repo):
        """Test status command with git option."""
        mock_repo = MagicMock()
        mock_get_repo.return_value = mock_repo
        mock_status_data = {"repository": {}, "files": {}, "git": {}}
        mock_get_status.return_value = mock_status_data
        mock_git_status = {"staged": [], "modified": [], "untracked": []}
    ...
    def test_status_command_with_summary(self, mock_display_summary, mock_display, mock_get_status, mock_get_repo):
    ...
    @patch('spec_cli.cli.commands.status.get_spec_repository')
    def test_status_command_repository_error(self, mock_get_repo):
    ...
    @patch('spec_cli.cli.commands.status.get_spec_repository')
    def test_status_command_unexpected_error(self, mock_get_repo):
...
class TestStatusHelperFunctions:
    ...
    def test_get_repository_status(self, mock_path):
    ...
    def test_get_git_status_data_success(self):
    ...
    def test_get_git_status_data_exception(self):
    ...
    @patch('spec_cli.cli.commands.status.Path')
    def test_get_repository_health_healthy(self, mock_path):
        ...
        with patch('spec_cli.cli.commands.status._get_git_status_data') as mock_git:
            mock_git.return_value = {"staged": ["file.md"], "modified": [], "untracked": []}
    ...
    @patch('spec_cli.cli.commands.status.Path')
    def test_get_repository_health_errors(self, mock_path):
        ...
        with patch('spec_cli.cli.commands.status._get_git_status_data') as mock_git:
            ...
            assert ".spec directory missing" in health["repository_structure"]["details"]
            assert health["git_configuration"]["status"] == "error"

    @patch('spec_cli.cli.commands.status.get_console')
    def test_display_git_status_with_files(self, mock_get_console):
    ...
    @patch('spec_cli.cli.commands.status.get_console')
    def test_display_git_status_clean(self, mock_get_console):
    ...
    def test_display_processing_summary(self):
