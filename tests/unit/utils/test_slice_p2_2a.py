...
class TestAnalyzeFunctionSignature:
    ...
    def test_analyze_function_signature_when_valid_function_then_returns_signature_report(self):
    ...
    def test_analyze_function_signature_when_click_command_then_identifies_parameters(self):
    ...
    def test_analyze_function_signature_when_context_parameter_variations_then_detects_all(self):
    ...
    def test_analyze_function_signature_when_no_annotations_then_handles_gracefully(self):
    ...
    def test_analyze_function_signature_when_complex_signature_then_marks_incompatible(self):
    ...
    def test_analyze_function_signature_when_invalid_input_then_raises_analysis_error(self):
    ...
    def test_analyze_function_signature_when_inspection_fails_then_raises_analysis_error(self):
...
class TestValidateDecoratorCompatibility:
    ...
    def test_validate_decorator_compatibility_when_compatible_function_then_returns_true(self):
    ...
    def test_validate_decorator_compatibility_when_incompatible_function_then_returns_false(self):
    ...
    def test_validate_decorator_compatibility_when_varargs_only_then_returns_false(self):
    ...
    def test_validate_decorator_compatibility_when_mixed_parameters_then_returns_true(self):
    ...
    def test_validate_decorator_compatibility_when_analysis_fails_then_returns_false(self):
        """Test compatibility validation returns False when analysis fails."""
        result = validate_decorator_compatibility("not a function")

        assert result is False

    def test_validate_decorator_compatibility_when_no_parameters_then_returns_true(self):
...
class TestSignatureReport:
    ...
    def test_signature_report_when_created_then_has_required_fields(self):
        ...
        report = SignatureReport(
            ...
            parameters={"param1": {"annotation": "str", "default": None, "kind": "POSITIONAL_OR_KEYWORD"}},
...
class TestDecoratorAnalysisError:
    ...
    def test_decorator_analysis_error_when_created_with_message_then_preserves_message(self):
    ...
    def test_decorator_analysis_error_when_created_with_context_then_preserves_context(self):
...
class TestDecoratorAnalysisEdgeCases:
    ...
    def test_analyze_function_signature_when_lambda_function_then_analyzes_correctly(self):
    ...
    def test_analyze_function_signature_when_builtin_function_then_handles_gracefully(self):
    ...
    def test_validate_decorator_compatibility_when_exception_during_analysis_then_returns_false(self):
        ...
        with patch('spec_cli.utils.decorator_analysis.analyze_function_signature') as mock_analyze:
...
class TestDecoratorAnalysisIntegrationScenarios:
    ...
    def test_analyze_click_command_signature_when_realistic_command_then_analyzes_correctly(self):
    ...
    def test_validate_decorator_compatibility_when_cli_commands_then_all_compatible(self):
    ...
    def test_decorator_analysis_performance_when_multiple_functions_then_completes_quickly(self):
