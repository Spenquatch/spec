...
class TestDetectEnvironmentType:
    ...
    def test_detect_environment_type_when_cli_args_then_returns_cli(self):
        ...
        with (
            ...
            patch.dict(os.environ, {}, clear=True),
            patch("spec_cli.utils.factory_utils.inspect.currentframe", return_value=None),
        ):
            # Remove pytest from modules temporarily if present
            pytest_module = sys.modules.pop("pytest", None)
            try:
...
class TestValidateFactoryInputs:
    ...
    def test_validate_factory_inputs_when_valid_config_then_returns_validated_config(self):
    ...
    def test_validate_factory_inputs_when_factory_type_string_conversion_then_normalizes(self):
        """Test factory_type string normalization."""
        result = validate_factory_inputs(factory_type="  CONTEXT  ")
        assert result["factory_type"] == "context"

    def test_validate_factory_inputs_when_timeout_string_conversion_then_converts_to_int(self):
    ...
    def test_validate_factory_inputs_when_debug_mode_string_conversion_then_converts_to_bool(self):
    ...
    def test_validate_factory_inputs_when_factory_config_copy_then_creates_independent_copy(self):
    ...
    def test_validate_factory_inputs_when_unvalidated_parameters_then_passes_through(self):
    ...
    def test_validate_factory_inputs_when_invalid_factory_type_then_raises_type_error(self):
    ...
    def test_validate_factory_inputs_when_invalid_debug_mode_then_raises_type_error(self):
    ...
    def test_validate_factory_inputs_when_invalid_factory_config_then_raises_type_error(self):
    ...
    def test_validate_factory_inputs_when_mixed_valid_invalid_then_validates_good_raises_bad(self):
    ...
    def test_validate_factory_inputs_when_all_parameter_types_then_validates_correctly(self):
