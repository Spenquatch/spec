...
class TestDebugLogger:
    ...
    def test_debug_logger_respects_environment_variables(self):
    ...
    def test_debug_logger_disabled_when_spec_debug_false(self):
    ...
    def test_debug_logger_formats_structured_data(self):
    ...
    def test_debug_logger_handles_different_log_levels(self):
    ...
    def test_debug_logger_timer_measures_duration(self):
    ...
    def test_debug_logger_timer_handles_exceptions(self):
    ...
    def test_debug_logger_logs_spec_error_context(self):
        """Test that DebugLogger logs SpecError context information."""
        with patch.dict(os.environ, {"SPEC_DEBUG": "1"}):
            logger = DebugLogger()

            # Create SpecError with context
            error = SpecGitError("Git operation failed", {"repo": ".spec", "command": "git add"})
    ...
    def test_debug_logger_logs_function_calls_with_args(self):
    ...
    def test_debug_logger_timer_disabled_when_timing_disabled(self):
    ...
    def test_debug_logger_log_error_with_additional_context(self):
